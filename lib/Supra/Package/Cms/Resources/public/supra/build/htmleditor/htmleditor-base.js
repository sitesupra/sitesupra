...
YUI().add('supra.htmleditor-base', function (Y) {
	...
	Y.extend(HTMLEditor, Y.Base, {
		...
		renderDelayed: function () {
			...
			// Enable if needed
			this.after('disabledChange', this.attrDisabledChange, this);
			this.attrDisabledChange({'newVal': this.get('disabled')});
		},
		...
		attrDisabledChange: function (e) {
			...
			if (value) {
				...
				this.fire('editingAllowedChange', {'allowed': true});
