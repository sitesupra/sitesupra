		...
		render: function (node) {
			...
			if (node.test) {
				...
				if (!svg) {
					...
					// ClassName
					ysvg = Y.Node(svg);
					ysvg.removeClass(ALIGN_CLASS_NAMES.left)
						.removeClass(ALIGN_CLASS_NAMES.right)
						.removeClass(ALIGN_CLASS_NAMES.center);
					
					if (this.align) {
						ysvg.addClass(ALIGN_CLASS_NAMES[this.align]);
					}
